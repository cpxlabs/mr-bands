      ...
      <div ref={revealRef} className="reveal w-[min(1120px,92vw)] mx-auto">
        ...
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-10">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="font-display text-sm tracking-widest uppercase mb-1" style={{ color: accent }}>
                Localização
              </h3>
              <p className="text-[#bcbcbc]">São Paulo, Brasil</p>
            </div>
            <div>
              <h3 className="font-display text-sm tracking-widest uppercase mb-1" style={{ color: accent }}>
                E-mail
              ...
              <a
                ...
                className="text-[#bcbcbc] hover:underline transition-colors"
            ...
            <div>
              <h3 className="font-display text-sm tracking-widest uppercase mb-2" style={{ color: accent }}>
                Redes sociais
              </h3>
              <ul className="flex flex-col gap-2 list-none p-0">
                {["Instagram", "WhatsApp", "Behance"].map((s) => (
                  <li key={s}>
                    <a
                      href="#"
            ...
            {[
              ...
              >
                ...
                <input
                  ...
                  className="w-full border border-[#222] bg-[#0d0d0d] text-[#f7f7f7] px-3 py-2 font-[inherit] focus:outline-none"
